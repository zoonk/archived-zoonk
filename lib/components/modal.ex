...
defmodule UneebeeWeb.Components.Modal do
  ...
  def modal(assigns) do
    ...
    <div id={@id} phx-mounted={@show && show_modal(@id)} phx-remove={hide_modal(@id)} data-cancel={JS.exec(@on_cancel, "phx-remove")} class="relative z-50 hidden">
      <div id={"#{@id}-bg"} class="bg-gray-light3x/90 fixed inset-0 transition-opacity" aria-hidden="true" />
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-gray-dark/10 ring-gray-dark/10 relative hidden h-screen bg-white p-8 shadow-lg ring-1 transition lg:h-auto lg:rounded-2xl"
            >
