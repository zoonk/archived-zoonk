defmodule UneebeeWeb.PermissionError do
  ...
  @impl Exception
  def exception(code: :school_already_configured), do: %__MODULE__{message: dgettext("errors", "School already configured")}
  def exception(code: :require_manager), do: %__MODULE__{message: dgettext("errors", "Only managers can view this page")}
